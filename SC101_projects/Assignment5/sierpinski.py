...
def main():
	"""
	prints the Sierpinski triangle recursively
	"""
...
def sierpinski_triangle(order, length, upper_left_x, upper_left_y):
	"""
	:param order: int, recursion times
	:param length: int, length of a triangle's side
	...
	if order == 0:
		...
		line2 = GLine(upper_left_x + length * 0.5, upper_left_y + length * 0.866, upper_left_x, upper_left_y)
