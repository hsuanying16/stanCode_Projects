...
Name: Sharon
------------------------
This program is plus two linked lists
and return a new linked list(sum of the two linked list)
"""
...
def add_2_numbers(l1: ListNode, l2: ListNode) -> ListNode:
    ...
    while l1 is not None or l2 is not None:
        ...
        if l2 is not None:
            num += l2.val
            l2 = l2.next
        cur.next = ListNode(num % 10)   # take the unit digit of num
        num = num // 10                 # check if num > 10 or not
        cur = cur.next
    if num != 0:
